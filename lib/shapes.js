// All shapes will have these properties, so make it a class to extend from
class AllShapes {
...
// Triangle class, takes in one side from user and creates polygon points that are equilateral
